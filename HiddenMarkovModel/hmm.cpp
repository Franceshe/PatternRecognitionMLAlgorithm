...
void Model::ComputeAlpha(int *seq, int seqLength)
{
  ...
  while (t<seqLength) {
	...
	// ============= Uncomment and complete the following assignment to compute alpha[t][i]
	// alpha[t][i] += ;
...
void Model::ComputeBeta(int *seq, int seqLength)
{
  ...
  while (t>=0) {
	...
	//==============Uncomment and finish the following assignment to compute beta[t][i].
        // beta[t][i] += ; 
...
void Model::AccumulateCounts(int *seq, int seqLength)
{
  ...
  for (t=0; t<seqLength; t++) {
    ...
    for (j=0; j<N; j++ ) {
      ...
      // ============ Uncomment and finish the following assignment statement to compute gamma[t][j]
  ...
  for (i=0; i<N; i++) {
    ...
    // ========= Uncomment and finish the following assignment statement for 
  ...
  for (t=0; t<seqLength; t++) {
    for (j=0; j<N; j++) {
      ...
      // ========= Uncomment and finish the following assignment statement for c
      // ounting for output probabilities
  ...
  for (t=0; t<seqLength-1; t++) {
	...
	// ========= Uncomment and finish the following assignment statement to 
	// count for state transition probabilities
	// Use  formula (6) in the note on HMMs.
	// Remember that the eta array has all the normalizers.
